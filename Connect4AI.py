...
class GameTreePlayer:    
    ...
    def winning_positions_heuristic(self, board, move, player):
        tempBoard = self.makeMove(board, move, player)[0]
        winning_positions = self.count_winning_positions(tempBoard, player)
        return winning_positions

    def count_winning_positions(self, board, piece):
        winning_positions = 0
        ...
        for r in range(6):
            for c in range(7):
                if board[r][c] == piece:
                    ...
                    if c + 3 < 7 and board[r][c + 1] == piece and board[r][c + 2] == piece and board[r][c + 3] == 0:
                        winning_positions += 1
                    # Check vertical winning positions
                    if r + 3 < 6 and board[r + 1][c] == piece and board[r + 2][c] == piece and board[r + 3][c] == 0:
                        winning_positions += 1
                    # Check positively sloped diagonal winning positions
                    if r + 3 < 6 and c + 3 < 7 and board[r + 1][c + 1] == piece and board[r + 2][c + 2] == piece and board[r + 3][c + 3] == 0:
                        winning_positions += 1
                    # Check negatively sloped diagonal winning positions
                    if r - 3 >= 0 and c + 3 < 7 and board[r - 1][c + 1] == piece and board[r - 2][c + 2] == piece and board[r - 3][c + 3] == 0:
                        winning_positions += 1
...
def RunTestCase():
    ...
    print("Roll no : 2020B3A71794G") #Put your roll number here
